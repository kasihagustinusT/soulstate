...
<Admonition type="tip" title="The Benefit">
  <p>By using the microtask queue, SoulState guarantees that the UI will never show an incomplete state. All updates from a single user interaction are processed and rendered together, resulting in a smooth and consistent user experience. This completely eliminates the possibility of UI tearing.</p>
</Admonition>
