...
<Admonition type="info" title="No Performance Penalty">
  <p>Modularizing your store with slices has <strong>no runtime performance cost</strong>. SoulState's propagation engine treats the combined tree as a single graph, providing the same systems-grade throughput as a flat store.</p>
</Admonition>
